...
createTargetLoopWorkshareCall(OpenMPIRBuilder &OMPBuilder, bool IsDistribute,
                              ...
                              Value *TripCountOrig, Function &LoopBodyFn) {
...
OpenMPIRBuilder::applyWorkshareLoopDevice(DebugLoc DL, CanonicalLoopInfo *CLI,
  ...
  // body.
  AllocaInst *newLoopCnt =
      Builder.CreateAlloca(CLI->getIndVarType(), nullptr, "new_loop_count");
...
OpenMPIRBuilder::createTargetInit(const LocationDescription &Loc, bool IsSPMD,
  ...
  Constant *MinThreads = ConstantInt::getSigned(Int32, 1);
  Constant *MaxThreads = ConstantInt::getSigned(Int32, 256);
  Constant *MinTeams = ConstantInt::getSigned(Int32, 0);
  Constant *MaxTeams = ConstantInt::getSigned(Int32, 0);
